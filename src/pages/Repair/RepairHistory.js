import {
  Table, Input, InputNumber, Popconfirm, Form, Divider, Modal, Tree, Button, Row, Col, Icon, Select, Alert, Tag, message, Card, DatePicker, Empty, PageHeader
} from 'antd';
...
class RepairHistory extends React.Component {
  ...
  render() {
    let { postData, postUrl, fv, fields, iftype, curitem, vs } = this.state,
      { hisToryqueryList, repairTypeList, faultTypeList, chart, hisgetRepairDetail, dataList, confirmDetails, repairStatusList,shopList } = this.props.repair;
    ...
    const columns = [
      ...
      },
      {
        ...
        render: (text) => <span style={{ color: text == "待维修" ? "#666" : text == "已完成" ? "green" : text == "已撤销" ? "#f50" : "#000" }}>{text}</span>
      },
      {
    ...
    return (
      <div>
        ...
        >
          <Card style={{ marginBottom: 12 }} title='设备信息'>
            <div className={styles.limitdiv} style={{ position: "relative" }}>
              <img className={this.state.visible && hisgetRepairDetail.status == "4" ? styles.readed : styles.read} src="./images/readed.png" alt="" />
              <Row gutter={24}>
                <Col {...coler}>
                  <p>
                    <span>
                  ...
                  <Row gutter={0}>
                    ...
                    <Col {...coler}>
                      <p>
                        ...
                        <span>
                          {
                            hisgetRepairDetail.applyTypeName
                          }
                        </span>
                      </p>
                    </Col>
                    <Col {...coler}>
                      <p>
                        ...
                        <span>
                          {
                            hisgetRepairDetail.applyPhenomenonName
                          }
                        </span>
                      </p>
                    </Col>
                    ...
                    <span>
                      <img onClick={() => {
                        Modal.info({
                          ...
                          content: (
                            <div style={{ width: "100%" }}>
                              <img style={{ width: "100%", height: "auto", margin: "20px 0px" }} src={hisgetRepairDetail.faultPicUrl ? hisgetRepairDetail.faultPicUrl : "./images/default.png"} onError={(e) => { e.target.src = './images/default.png' }} />
                            </div>
                          ),

                        });

                      }} style={{ width: 120, height: 120, cursor: "pointer" }} src={hisgetRepairDetail.faultPicUrl ? hisgetRepairDetail.faultPicUrl : "./images/default.png"} onError={(e) => { e.target.src = './images/default.png' }} />
                    </span>
                  </p>
              ...
              <Row gutter={24}>
                ...
                <Col {...coler}>
                  <p>
                    ...
                    <span>
                      {
                        hisgetRepairDetail.faultPhenomenon
                      }
                    </span>
                  </p>
                </Col>
                ...
                <Col span={24}>
                  <p>
                    ...
                    <span>
                      {
                        hisgetRepairDetail.faultReasonName
                      }
                    </span>
                  </p>
                </Col>
              ...
              <Row gutter={24}>
                ...
                <Col {...coler}>
                  <p>
                    ...
                    <span>
                      {
                        hisgetRepairDetail.repairIsPowerOff == "0" ? "不停机" : "停机"
                      }
                    </span>
                  </p>
                </Col>
                ...
                <Col {...coler}>
                  <p>
                    ...
                    <span>{hisgetRepairDetail.repairUserConfirmBox == "0" ? "不通过" : hisgetRepairDetail.repairUserConfirmBox == "1" ? "通过" : ""}</span>
                  </p>
                </Col>
                <Col {...coler}>
                  <p>
                ...
                <Col {...coler}>
                  <p>
                    ...
                    <span>{hisgetRepairDetail.repairMin ? hisgetRepairDetail.repairMin + "分钟" : ""}</span>
                  </p>
                </Col>
                <Col span={24}>
                  <p>
        ...
        <Card title={this.props.location.query.isCurrentUserAudit == "1" ? "我的撤回审批" : "历史维修单列表"} extra={
          <span>
            <a style={{ display: curitem.id && curitem.status == "4" ? "inline-block" : "none" }} onClick={() => {
              this.setState({
                vs: true
              })
            }}>打印</a>
            <Divider style={{ display: curitem.id && curitem.status == "4" ? "inline-block" : "none" }} type='vertical' />
            <a onClick={() => {
              message.loading("正在导出文件...")
            }} href={`/rs/equipmentRepairHis/exportExcel?${bodyparse(this.state.postData)}`} target="_blank">导出详情</a>
            <Divider type='vertical' />
            <a onClick={() => {
              message.loading("正在导出文件...")
            }} href={`/rs/equipmentRepairHis/exportByIds?${bodyparse(this.state.postData)}`} target="_blank">导出维修单</a>
          </span>
        }>
