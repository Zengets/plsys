...
import {
    ...
    weiwaicreate, queryBusinessByUserId,
    equipmentqueryNoByUserId, equipmentqueryByUserId,
    repairqueryList, modifyRepairUser, getRepairDetail, queryAllRepair, rslmodifyRepairUser, rslgetRepairDetail, TroublequeryTreeList,
    Troublesave, TroubledeleteById, hisToryqueryList, hisgetRepairDetail, deviceTypequeryTreeList,
    weiqueryList, weiauditExternalRepair, weiconfigBack, association, uiassociation,queryUpdateByUserId,replaceUser
...
export default {
    ...
    effects: {
        ...
        *hisToryqueryList({ payload }, { call, put }) {//datalist
            ...
            yield put({
                type: 'updateState',
                payload: { repairStatusList: responese.data.repairStatusList ? responese.data.repairStatusList : [] }
            })
            yield put({
                type: 'updateState',
        ...
        *weiwaicreate({ payload }, { call, put }) {//datalist
