...
class checkSetting extends React.Component {
  ...
  render() {
    let { postData, postUrl, fv, fields, iftype, curitem, charge, selectedRowKeys, selectedRowKeyc, postDatas, postDatac } = this.state,
      { equipmentqueryList, userList, uiassociation, equipmentqueryNoByUserId, equipmentqueryByUserId, deviceTypequeryTreeList, companyList } = this.props.check;
    const rowSelections = {
      ...
      <div>
        ...
        <Card title='点检负责人' extra={
                ...
                this.setNewState("queryBusinessByUserId", null, () => {
                  Modal.confirm({
                    ...
                    content: <div style={{ paddingTop: 12 }}>
                      ...
                      >
                        {
                          _it.props.check.queryBusinessByUserId ?
                            _it.props.check.queryBusinessByUserId.map((item) => {
          ...
          <Modal
            ...
            footer={iftype.value == "edit"||iftype.value == "rechange" ? [<Button key="back" onClick={() => { this.setState({ visible: false }) }}>
              取消
            </Button>,
                      ...
                      onChange={(val) => {
                        this.setState({
                          ...
                          this.setNewState("queryUpdateByUserId", {
                            ...
                            this.setState({
                              queryUpdateByUserId: this.props.check.queryUpdateByUserId
                            })
                          })
                        })
                      }}
