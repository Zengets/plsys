...
class VerbPlanSet extends React.Component {
  ...
  render() {
    let { postData, postUrl, fv, fields, iftype, curitem, charge, selectedRowKeys, selectedRowKeyc, postDatas, postDatac } = this.state,
      { equipmentqueryList, userList, uiassociation, equipmentqueryNoByUserId, equipmentqueryByUserId, deviceTypequeryTreeList, companyList } = this.props.verb;
    const rowSelections = {
                ...
                this.setNewState("queryBusinessByUserId", null, () => {
                  Modal.confirm({
                    ...
                    content: <div style={{ paddingTop: 12 }}>
                      ...
                      >
                        {
                          _it.props.verb.queryBusinessByUserId ?
                            _it.props.verb.queryBusinessByUserId.map((item) => {
                    ...
                    onChange={(val) => {
                      this.setState({
                        ...
                        this.setNewState("queryUpdateByUserId", {
                          ...
                          this.setState({
                            queryUpdateByUserId: this.props.verb.queryUpdateByUserId
                          })
                        })
                      })
                    }}
