 ...
 */
import {
    devicequeryList, queryPageList, verbqueryItemForAdd, outqueryList, pairqueryPageByUserId, queryApplyReapairList, getProductors,
    uploadsysUser, uploaduserEquipment, uploadequipment,uploadequipmentMaintainItem, uploadequipmentFaultType, uploadspareParts, uploadequipmentMaintainPlan,uploadproductMonthPlanDetail,
    uploadbuddleEquipment, uploadequipmentSpareRel, uploadequipmentPointCheckPlan,uploadproductPlan,uploadelectricityMeterReadDay,queryPageListPlus, DSparequery,
    replysave, queryListByKnowledgeId, queryListByParentIds, replydeleteById, uploadproductionPecification, queryByConditionPage,
    queryUseListByComId
...
export default {
    ...
    effects: {
        *queryByConditionPage({ payload }, { call, put }) {//datalist
        ...
        *DSparequery({ payload }, { call, put }) {//datalist
        ...
        *uploadequipmentMaintainItem({ payload }, { call, put }) {//datalist
        ...
        *uploadproductMonthPlanDetail({ payload }, { call, put }) {//datalist
        ...
        *uploadproductPlan({ payload }, { call, put }) {//datalist
        ...
        *uploadelectricityMeterReadDay({ payload }, { call, put }) {//datalist
        ...
        *uploadbuddleEquipment({ payload }, { call, put }) {//datalist
        ...
        *uploadequipmentSpareRel({ payload }, { call, put }) {//datalist
        ...
        *uploadequipmentPointCheckPlan({ payload }, { call, put }) {//datalist
        ...
        *uploadproductionPecification({ payload }, { call, put }) {//datalist
        ...
        *queryUseListByComId({ payload }, { call, put }) {//datalist
        ...
        *queryPageListPlus({ payload }, { call, put }) {//datalist
